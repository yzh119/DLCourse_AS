...
class ThreeLayerConvNet(object):
  ...
  def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
    ...
    self.params['W1'] = weight_scale * \
        np.random.randn(F, C, HH, WW)
    self.params['b1'] = weight_scale * \
        np.random.randn(F)
    ...
    self.params['W2'] = weight_scale * np.random.randn(F * H * W, hidden_dim)
  ...
  def loss(self, X, y=None):
    ...
    dout_1, grads['W1'], grads['b1'] = conv_relu_pool_backward(dout_2, cache_1)
    
    # They must be put here because of +=    
